...
class App extends React.Component{
    ...
    componentDidMount() {
        ...
        let options = {
            ...
            sources: [{
                type: "rtmp/flv",
                src: 'rtmp://192.168.88.91:1935/rtmplive/room'
            }],
            flash: { swf: videoSWF },
            live: true,
        }
        ...
        //         src: "http://192.168.88.91/hls/room.m3u8",
        ...
        return(
            <div className="Mode_2">
                <Button disabled={this.state.disable} onClick={()=>{
                    ...
                    _fetch('http://192.168.88.91:7000/change_mode', {mode:0},(json)=>{
                        console.log(json)
                    })
                }}>检测</Button>
                <Button disabled={this.state.disable} style={{
                    marginLeft:20
                }} onClick={()=>{
                    this.setState({
                        disable:true
                    ...
                    _fetch('http://192.168.88.91:7000/change_mode', {mode:1},(json)=>{
                        console.log(json)
                    })
                }}>分割</Button>
                <Button disabled={this.state.disable} style={{
